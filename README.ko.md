...
- “좋겠어”, “했으면 해”, “원해”, “달라고”, 영어의 “I wish”, “I want”, “ask it to”처럼 원하는 결과나 결과물을 말하면 모호하지 않은지 판단해 자동으로 요청을 정리합니다.
- 정리한 요청과 확인 질문을 사용자가 쓴 언어로 돌려줍니다.
...
모든 사전 항목은 한국어와 영어 표현을 함께 담고 있고, 두 스킬 모두 **사용자가 쓴 언어로 답합니다.** 영어로 물으면 영어로, 한국어로 물으면 한국어로 돌려줍니다. 원인 후보나 구분 기준처럼 언어와 무관한 판단 기준은 사전에 한국어로만 적혀 있으며, 답변할 때 사용자의 언어로 옮깁니다.
...
<details>
<summary><strong>Codex 플러그인 설치</strong></summary>
...
<details>
<summary><strong>Claude Code 플러그인 설치</strong></summary>
